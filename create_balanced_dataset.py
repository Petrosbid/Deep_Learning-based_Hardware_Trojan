...
INPUT_FILE = "labeled_traces_ALL.jsonl"
# فایل خروجی نهایی برای فاز 3 (آموزش LSTM)
OUTPUT_FILE = "labeled_traces_BALANCED.jsonl"
...
def main():
    ...
    # ==================================================================
    # مرحله 1: خواندن فایل برای جمع‌آوری تروجان‌ها و شمارش داده‌های سالم
    # ==================================================================
    ...
    # ==================================================================
    # مرحله 2: Downsampling نمونه‌های سالم
    # ==================================================================
    ...
    # ==================================================================
    # مرحله نهایی: ادغام، مخلوط کردن و ذخیره
    # ==================================================================
